...
export default function RefrigeratorRepairPage() {
  const service = servicesData.find((s) => s.slug === "refrigerator-repair");

  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Refrigerator Repair in Navi Mumbai",
    "provider": {
    ...
    "serviceType": "Refrigerator Repair & Servicing",
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-100 text-blue-800 text-xs sm:text-sm font-semibold">
                ...
                <span>Single Door, Double Door & Inverter Refrigerators</span>
              </div>

              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-tight">
                Refrigerator Repair in <br className="hidden sm:inline" />
                <span className="text-blue-700">Navi Mumbai</span>
              </h1>

              <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl">
                Reliable doorstep troubleshooting for cooling failure, excessive ice formation, gas leaks, thermostat issues, and compressor breakdowns across all Navi Mumbai residential sectors.
              </p>
              ...
              <div className="pt-3 grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs font-semibold text-slate-600">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>Frost-Free & Direct Cool</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CheckCircle2 className="w-4 h-4 text-blue-600 shrink-0" />
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200/80 bg-white">
                ...
                <div className="absolute bottom-3 left-3 bg-slate-900/90 text-white text-xs font-bold px-3 py-1.5 rounded-lg backdrop-blur-xs">
                  Compressor & Cooling Diagnostic Check
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <span className="text-xs font-bold uppercase tracking-wider text-blue-600 bg-blue-50 px-3 py-1 rounded-full">
              Refrigerator Faults Handled
            </span>
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight mt-2">
              Common Refrigerator Problems
            </h2>
            <p className="mt-2 text-sm text-slate-600">
              We inspect cooling loops, defrost circuits, thermostats, and compressors on-site.
            </p>
          </div>
      ...
      <section className="py-12 sm:py-16 bg-slate-50 border-t border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Precision diagnostics for modern direct-cool and frost-free inverter refrigerators.
            </p>
          </div>
            ...
            {service.serviceHighlights.map((item, idx) => (
              ...
              >
                ...
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  Carefully performed on-site by experienced refrigeration technicians.
                </p>
              </div>
            ))}
          </div>
      ...
      {/* BOOKING CTA */}
      <BookingCTA
        title="Fridge Not Cooling or Making Noise?"
        subtitle="Schedule a doorstep inspection technician across Navi Mumbai today."
      />
      ...
      <FAQAccordion
        ...
        subtitle="Factual guidance regarding cooling coils, defrost heaters, and our ₹149 inspection."
      />
    </>
  );
}
