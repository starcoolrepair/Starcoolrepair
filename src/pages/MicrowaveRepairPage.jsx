...
export default function MicrowaveRepairPage() {
  const service = servicesData.find((s) => s.slug === "microwave-repair");

  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Microwave Repair in Navi Mumbai",
    "provider": {
    ...
    "serviceType": "Microwave Oven Repair & Servicing",
    ...
    <>
      ...
      <div className="bg-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Breadcrumbs items={[{ label: "Microwave Repair" }]} />
        </div>
      </div>

      {/* UNIQUE MICROWAVE HERO */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-100 text-blue-800 text-xs sm:text-sm font-semibold">
                ...
                <span>Solo, Grill & Convection Microwave Diagnosis</span>
              </div>

              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 tracking-tight leading-tight">
                Microwave Repair in <br className="hidden sm:inline" />
                <span className="text-blue-700">Navi Mumbai</span>
              </h1>

              <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl">
                Safe, expert doorstep microwave oven diagnostics across all Navi Mumbai residential sectors. Fast resolution for heating failure, sparking, unresponsive touchpads, turntable issues, and power faults.
              </p>
              ...
              <div className="pt-3 grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs font-semibold text-slate-600">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>Safe High-Voltage Checks</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <CheckCircle2 className="w-4 h-4 text-blue-600 shrink-0" />
            ...
            <div className="lg:col-span-5">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-200/80 bg-white">
                ...
                <div className="absolute bottom-3 left-3 bg-slate-900/90 text-white text-xs font-bold px-3 py-1.5 rounded-lg backdrop-blur-xs">
                  Microwave Safety & Heating Testing
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 sm:py-16 bg-slate-50 border-t border-slate-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-10">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Complete diagnostic care for convection, grill, and solo microwave ovens.
            </p>
          </div>
            ...
            {service.serviceHighlights.map((item, idx) => (
              ...
              >
                ...
                <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                  Carefully performed on-site by experienced technicians observing all microwave safety protocols.
                </p>
              </div>
            ))}
          </div>
      ...
      {/* BOOKING CTA */}
      <BookingCTA
        title="Microwave Not Heating or Sparking?"
        subtitle="Book a safe doorstep inspection technician in Navi Mumbai today."
      />
      ...
      <FAQAccordion
        ...
        subtitle="Answers regarding high-voltage magnetron testing, internal sparking, and our ₹149 inspection."
      />
    </>
  );
}
